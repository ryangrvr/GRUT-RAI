...
class TestPerChapterOpenNegatives:
    ...
    def test_chapter_6_includes_constitutive_projection_via_affects(self):
        ...
        Post-Corrections-#23/#24/#25: the original heuristic open question
        is resolved at the linearized level (Correction #23), scaffolded
        at the curved-background level (Correction #24), and explicit at
        Phase 2C on FRW (Correction #25); the Phase 2D beyond-WKB
        refinement (O(10⁻⁶) correction) is the remaining open question."""
        from grut.toe.render import render_chapter_open_negatives
        out = render_chapter_open_negatives(6)
