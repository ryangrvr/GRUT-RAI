...
REGISTRY: tuple[Claim, ...] = (
    ...
    Claim(
        ...
        statement=(
            ...
            "chronology anchor: T_c crossing at t ≈ 16.5 hours post-Big "
        ...
        notes=(
            ...
            "cosmological-chronology pin (T at t ≈ 16.5 hours post-Big "
    ...
    Claim(
        ...
        statement=(
            ...
            "minimum Δm²_atm/Δm²_sol = 194.1, vs observed 33.9 — a "
        ...
        falsifier=(
            ...
            "claim is falsified. The computed minimum 194.1 is "
    ...
    Claim(
        ...
        statement=(
            ...
            "t ≈ 16.5 hours post-Big Bang. The 34-orders-of-magnitude "
    ...
    Claim(
        ...
        notes=(
            ...
            "(inertia, auxiliary field, structured memory) Phase II turned up. "
            "PHASE II VERDICT (computed, June 2026): #poles = #independent "
            "responsive variables; coupled RELAXATIONAL variables never give a "
            "stable OFF-AXIS (dark-capable) pole (12,800-pole scan over stable "
            "couplings — none found); a dark mode requires an INERTIAL, "
            "matter-like degree of freedom (z̈ + restoring). GRUT's vacuum is "
            "relaxational by construction (F: gradient-flow, single τ₀) with ONE "
            "responsive variable (TT memory; scalar killed by the No-Go; vector "
            "non-dynamical) atop the massless graviton ⇒ SINGLE-MODE ⇒ dark "
            "matter is a HOSTED matter field, permanently, within F. A derived "
            "dark sector requires EXTENDING F with an inertial matter DOF — "
