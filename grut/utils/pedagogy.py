    ...
    return {
        ...
        "steps": [
            ...
            {"step": 2, "title": "The Anomaly Structure",
             ...
             "explanation": "The 3-loop gravitational anomaly coefficient from SM field content: 3(99 + 2π² + 576 ln2 ζ₃)/(16384 π⁶). This is computed, not fitted.",
             "computed": {"C_FINAL": C_FINAL}},
            {"step": 3, "title": "The Structural Formula",
             "equation": "f(R) = 2 - R  →  H_∞ = (2 - R) / (S × τ₀)",
             "explanation": f"Confirmed from 3-loop CTP on de Sitter S⁴. R = {R_ANOMALY}, S = 108π = {S_CTP:.3f}. The competing quadratic f = R(2-R) is excluded by factor 70 in RMS.",
             "computed": {"R": R_ANOMALY, "S": S_CTP, "f_R": 2-R_ANOMALY}},
